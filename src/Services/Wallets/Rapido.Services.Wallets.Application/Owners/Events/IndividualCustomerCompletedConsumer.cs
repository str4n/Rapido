...
internal sealed class IndividualCustomerCompletedConsumer : IConsumer<IndividualCustomerCompleted>
{
    private readonly IIndividualOwnerRepository _ownerRepository;
    private readonly IClock _clock;
    private readonly IMessageBroker _messageBroker;

    public IndividualCustomerCompletedConsumer(IIndividualOwnerRepository ownerRepository, IClock clock, IMessageBroker messageBroker)
    {
    ...
    public async Task Consume(ConsumeContext<IndividualCustomerCompleted> context)
    {
        ...
        await _messageBroker.PublishAsync(new IndividualOwnerCreated(message.CustomerId, message.Nationality));
    }
}